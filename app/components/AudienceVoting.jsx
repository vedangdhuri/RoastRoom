 ...
 */
export default function AudienceVoting({ roomId, players, currentRound, isSpectator }) {
    ...
    useEffect(() => {
        const handleVoteUpdate = ({ round, voteTally: tally, totalVotes: total }) => {
    ...
    return (
        ...
        >
            ...
            {!votedFor && (
                <p className="text-xs text-gray-500 mt-2 text-center">Tap a player to cast your vote</p>
            )}
        </motion.div>
    );
}
