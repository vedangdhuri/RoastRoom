...
export default function CreateRoomPage() {
  ...
  const handleSuggestTopic = async () => {
    ...
    try {
      const topic = await roomService.suggestTopic(formData.mode);
      setFormData((prev) => ({ ...prev, topic }));
    } catch (e) {
      toast.error("Could not generate a topic. Try again!");
    } finally {
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-xs text-gray-400">
                  Formal arguments. Scored heavily on logic and clarity. (60s
                  timer)
                </p>
              </label>
              ...
              >
                ...
                <p className="text-xs text-gray-400">
                  No holds barred. Scored on creativity and humor. (30s timer)
                </p>
              </label>
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between items-end mb-1">
              ...
              <button
                ...
                className="text-xs text-brand-400 hover:text-brand-300 flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
              >
                {topicLoading ? (
                  <>
                    <svg
