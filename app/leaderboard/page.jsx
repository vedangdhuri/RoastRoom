...
const RankCard = ({ entry, myId }) => {
  ...
  return (
    ...
    >
      <div
        className={`w-8 text-center font-display font-bold text-lg ${medalColors[entry.rank] || "text-gray-500"}`}
      >
        {entry.rank <= 3
          ? ["🥇", "🥈", "🥉"][entry.rank - 1]
          : `#${entry.rank}`}
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          {isMe && (
            <span className="badge bg-brand-600/30 text-brand-300 text-xs">
              You
            </span>
          )}
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400">
          Top debaters and roasters fighting for glory.
        </p>
      </div>
